...
class MySQLTest extends Test
{
    ...
    #[TestWith(['column' => 'idroles', 'value' => 1, 'return' => 'idroles <> ?'])]
    #[TestWith(['column' => 'idroles', 'value' => 2, 'return' => 'idroles <> ?'])]
    public function notEqualToTest(string $column, int $value, string $return): void
    {
    ...
    #[TestWith(['value' => 3])]
    #[TestWith(['value' => 4])]
    public function notEqualToForSingleValue(int $value): void
    {
        $this->assertInstanceOf(MySQL::class, $this->mysql->notEqualTo($value));
        $this->assertAddRows([$value]);
        $this->assertSame('<> ?', $this->getQuery());
    }
    ...
    public function notEqualToSchema(string $column, string $value, string $return): void
    {
        $this->setPrivateProperty('isSchema', true);
    ...
    #[TestWith(['value' => 3])]
    #[TestWith(['value' => 4])]
    public function notEqualToSchemaForSingleValue(int $value): void
    {
        $this->setPrivateProperty('isSchema', true);
    ...
    #[TestWith(['column' => 'idroles', 'value' => 1, 'return' => 'idroles > ?'])]
    #[TestWith(['column' => 'idroles', 'value' => 2, 'return' => 'idroles > ?'])]
    public function greaterThanTest(string $column, int $value, string $return): void
    {
    ...
    #[TestWith(['value' => 3])]
    #[TestWith(['value' => 4])]
    public function greaterThanForSingleValue(int $value): void
    {
        $this->assertInstanceOf(MySQL::class, $this->mysql->greaterThan($value));
        $this->assertAddRows([$value]);
        $this->assertSame('> ?', $this->getQuery());
    }
    ...
    public function greaterThanSchema(string $column, string $value, string $return): void
    {
        $this->setPrivateProperty('isSchema', true);
    ...
    #[TestWith(['value' => 3])]
    #[TestWith(['value' => 4])]
    public function greaterThanSchemaForSingleValue(int $value): void
    {
        $this->setPrivateProperty('isSchema', true);
    ...
    #[TestWith(['column' => 'idroles', 'value' => 1, 'return' => 'idroles >= ?'])]
    #[TestWith(['column' => 'idroles', 'value' => 2, 'return' => 'idroles >= ?'])]
    public function greaterThanOrEqualToTest(string $column, int $value, string $return): void
    {
    ...
    #[TestWith(['value' => 3])]
    #[TestWith(['value' => 4])]
    public function greaterThanOrEqualToForSingleValue(int $value): void
    {
        $this->assertInstanceOf(MySQL::class, $this->mysql->greaterThanOrEqualTo($value));
        $this->assertAddRows([$value]);
        $this->assertSame('>= ?', $this->getQuery());
    }
    ...
    public function greaterThanOrEqualToSchema(string $column, string $value, string $return): void
    {
        $this->setPrivateProperty('isSchema', true);
    ...
    #[TestWith(['value' => 3])]
    #[TestWith(['value' => 4])]
    public function greaterThanOrEqualToSchemaForSingleValue(int $value): void
    {
        $this->setPrivateProperty('isSchema', true);
    ...
    #[TestWith(['column' => 'idroles', 'value' => 1, 'return' => 'idroles <= ?'])]
    #[TestWith(['column' => 'idroles', 'value' => 2, 'return' => 'idroles <= ?'])]
    public function lessThanOrEqualToTest(string $column, int $value, string $return): void
    {
    ...
    #[TestWith(['value' => 3])]
    #[TestWith(['value' => 4])]
    public function lessThanOrEqualToForSingleValue(int $value): void
    {
        $this->assertInstanceOf(MySQL::class, $this->mysql->lessThanOrEqualTo($value));
        $this->assertAddRows([$value]);
        $this->assertSame('<= ?', $this->getQuery());
    }
    ...
    public function lessThanOrEqualToSchema(string $column, string $value, string $return): void
    {
        $this->setPrivateProperty('isSchema', true);
    ...
    #[TestWith(['value' => 3])]
    #[TestWith(['value' => 4])]
    public function lessThanOrEqualToSchemaForSingleValue(int $value): void
    {
        $this->setPrivateProperty('isSchema', true);
